#if !defined(_RADIOLIB_LR2021_H)
#define _RADIOLIB_LR2021_H
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      \param syncWord 1-byte LoRa sync word. Defaults to RADIOLIB_LR20xx_LORA_SYNC_WORD_PRIVATE (0x12).
    ...
    */
    int16_t begin(float freq = 434.0, float bw = 125.0, uint8_t sf = 9, uint8_t cr = 7, uint8_t syncWord = RADIOLIB_LR20xx_LORA_SYNC_WORD_PRIVATE, int8_t power = 10, uint16_t preambleLength = 8, float tcxoVoltage = 1.6);
