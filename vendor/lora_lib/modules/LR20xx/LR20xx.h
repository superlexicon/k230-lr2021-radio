#if !defined(_RADIOLIB_LR20XX_H)
#define _RADIOLIB_LR20XX_H
 ...
 */
#define LR20XX_RADIO_COMMON_FRONT_END_CALIBRATION_STEP_IN_HZ 4000000
...
#define RADIOLIB_LR20xx_CMD_WRITE_REG_MEM_MASK                  (0x0105)
#define RADIOLIB_LR20xx_CMD_READ_REG_MEM                        (0x0106)

#define RADIOLIB_LR20xx_CMD_CLEAR_ERRORS                        (0x0111)
#define RADIOLIB_LR20xx_CMD_CLEAR_RX_BUFFER                     (0x011E)
#define RADIOLIB_LR20xx_CMD_CLEAR_TX_BUFFER                     (0x011F)
#define RADIOLIB_LR20xx_CMD_SET_DIO_AS_RF_SWITCH                (0x0113)
#define RADIOLIB_LR20xx_CMD_WRITE_BUFFER                        (0x0002)
#define RADIOLIB_LR20xx_CMD_READ_BUFFER                         (0x0001)

#define RADIOLIB_LR20xx_CMD_CONFIG_LF_CLOCK			  (0x0118)
#define RADIOLIB_LR20xx_CMD_SET_REG_MODE                        (0x0121)
#define RADIOLIB_LR20xx_CMD_GET_VERSION                         (0x0101)
#define RADIOLIB_LR20xx_CMD_GET_STATUS                          (0x0100)
#define RADIOLIB_LR20xx_CMD_GET_ERRORS                          (0x0110)
#define RADIOLIB_LR20xx_CMD_CALIBRATE                           (0x0122)
#define RADIOLIB_LR20xx_CMD_CALIBRATE_FRONT_END                 (0x0123)
#define RADIOLIB_LR20xx_CMD_SET_DIO_IRQ_PARAMS                  (0x0115)
#define RADIOLIB_LR20xx_CMD_SET_DIO_FUNC			  (0x0112)
#define RADIOLIB_LR20xx_CMD_SET_DIO_RF_SWITCH_CFG               (0x0113)
#define RADIOLIB_LR20xx_CMD_CLEAR_IRQ                           (0x0116)
//#define RADIOLIB_LR11X0_CMD_CONFIG_LF_LOCK                      (0x0116)
//#define RADIOLIB_LR11X0_CMD_SET_TCXO_MODE                       (0x0117)
#define RADIOLIB_LR20xx_CMD_CONFIG_FIFO_IRQ                     (0x011A)

#define RADIOLIB_LR20xx_CMD_CONFIG_GET_TX_FIFO_LEVEL            (0x011D)
#define RADIOLIB_LR20xx_CMD_CONFIG_GET_RX_FIFO_LEVEL            (0x011C)




#define RADIOLIB_LR20xx_CMD_SET_TCXO_MODE                       (0x0120)
...
#define RADIOLIB_LR20xx_CMD_SET_STANDBY                         (0x0128)

#define RADIOLIB_LR20xx_CMD_PATCH_EXECUTE_SPARE                 (0x012D)

#define    RADIOLIB_LR20xx_FIFO_FLAG_NONE            	  ( 0 << 0 )
#define    RADIOLIB_LR20xx_FIFO_FLAG_EMPTY          		  ( 1 << 0 )
#define    RADIOLIB_LR20xx_FIFO_FLAG_THRESHOLD_LOW   	 ( 1 << 1 )
#define    RADIOLIB_LR20xx_FIFO_FLAG_THRESHOLD_HIGH  	 ( 1 << 2 )
#define    RADIOLIB_LR20xx_FIFO_FLAG_FULL            	 ( 1 << 3 )
#define    RADIOLIB_LR20xx_FIFO_FLAG_OVERFLOW        	 ( 1 << 4 )
#define    RADIOLIB_LR20xx_FIFO_FLAG_UNDERFLOW       	 ( 1 << 5 )


#define    RADIOLIB_LR20xx_CMD_GET_FIFO_IRQ_FLAGS 		(0x011B)
#define    RADIOLIB_LR20xx_CMD_CLEAR_FIFO_IRQ_FLAGS 		(0x0114)
#define    RADIOLIB_LR20xx_CMD_GET_CLEAR_FIFO_IRQ_FLAGS 	(0x012E)
...
#define RADIOLIB_LR11X0_CMD_SET_FS                              (0x0129)


#define RADIOLIB_LR20xx_CMD_GET_PACKET_STATUS_LORA              (0x022A)
#define RADIOLIB_LR20xx_CMD_GET_PACKET_STATUS_FSK               (0x0247)
#define RADIOLIB_LR20xx_CMD_GET_RSSI_INST                       (0x020B)
#define RADIOLIB_LR20xx_CMD_GET_PACKET_STATUS_FLRC              (0x024B)
#define RADIOLIB_LR11X0_CMD_GET_RX_STATS_FLRC                   (0x024A)


#define RADIOLIB_LR20xx_CMD_GET_RX_PACKET_LENGTH                (0x0212)

#define RADIOLIB_LR20xx_CMD_SET_RX_PATH			  (0x0201)

#define RADIOLIB_LR20xx_CMD_GET_CLEAR_IRQ_STATUS                   (0x0117)
//#define RADIOLIB_LR20xx_CMD_GET_RSSI                   	   (0x020B)

#define RADIOLIB_LR20xx_CMD_SET_TX_PARAMS                       (0x0203)
#define RADIOLIB_LR20xx_CMD_SET_RF_FREQUENCY                    (0x0200)
#define RADIOLIB_LR20xx_CMD_SET_RX                              (0x020C)
#define RADIOLIB_LR20xx_CMD_SET_TX                              (0x020D)

#define RADIOLIB_LR20xx_CMD_SET_PACKET_PARAMS_LORA              (0x0221)
#define RADIOLIB_LR20xx_CMD_SET_PACKET_PARAMS_FSK               (0x0241)
#define RADIOLIB_LR20xx_CMD_SET_PACKET_PARAMS_BPSK              (0x0251)
#define RADIOLIB_LR20xx_CMD_SET_PACKET_PARAMS_FLRC              (0x0249)
#define RADIOLIB_LR20xx_CMD_SET_PACKET_PARAMS_WISUN             (0x0271)
...
#define RADIOLIB_LR20xx_CMD_GET_PACKET_TYPE                     (0x0208)
#define RADIOLIB_LR20xx_CMD_SET_PACKET_TYPE                     (0x0207)
#define RADIOLIB_LR20xx_CMD_SET_MODULATION_PARAMS_LORA          (0x0220)
#define RADIOLIB_LR20xx_CMD_SET_MODULATION_PARAMS_FSK           (0x0240)
#define RADIOLIB_LR20xx_CMD_SET_MODULATION_PARAMS_FLRC          (0x0248)
#define RADIOLIB_LR20xx_CMD_SET_MODULATION_PARAMS_BPSK          (0x0250)
#define RADIOLIB_LR20xx_CMD_SET_MODULATION_PARAMS_BLE           (0x0260)
#define RADIOLIB_LR20xx_CMD_SET_MODULATION_PARAMS_OOK           (0x0281)





#define RADIOLIB_LR20xx_CMD_SET_RX_TX_FALLBACK_MODE		  (0x0206)

#define RADIOLIB_LR20xx_CMD_SET_GFSK_CRC_PARAMS                 (0x0243)
#define RADIOLIB_LR20xx_CMD_SET_GFSK_WHIT_PARAMS                (0x0242)
...
#define RADIOLIB_LR20xx_CMD_SEL_PA                              (0x020F)
#define RADIOLIB_LR20xx_CMD_SET_TX_CW                           (0x020E)
#define RADIOLIB_LR20xx_CMD_SET_PA_CONFIG                       (0x0202)
#define RADIOLIB_LR20xx_CMD_SET_LORA_SYNC_WORD                  (0x0223)
#define RADIOLIB_LR20xx_CMD_SET_FSK_SYNC_WORD                   (0x0244)
#define RADIOLIB_LR20xx_CMD_SET_FLRC_SYNC_WORD                  (0x024C)
#define RADIOLIB_LR20xx_CMD_SET_LRFHSS_SYNC_WORD                (0x0257)
#define RADIOLIB_LR20xx_CMD_SET_OOK_SYNC_WORD                   (0x0284)
...
// RADIOLIB_LR20xx_CMD_GET_STATUS                                                   MSB   LSB   DESCRIPTION
#define RADIOLIB_LR20xx_STAT_1_CMD_FAIL                         (0x00UL << 1)   //  3     1     command status: last command could not be executed
#define RADIOLIB_LR20xx_STAT_1_CMD_PERR                         (0x01UL << 1)   //  3     1                     processing error
#define RADIOLIB_LR20xx_STAT_1_CMD_OK                           (0x02UL << 1)   //  3     1                     successfully processed
#define RADIOLIB_LR20xx_STAT_1_CMD_DAT                          (0x03UL << 1)   //  3     1                     successfully processed, data is being transmitted
...
// RADIOLIB_LR20xx_CMD_WRITE_REG_MEM
#define RADIOLIB_LR20xx_SPI_MAX_READ_WRITE_LEN                  (256)           //  7     0     maximum length of read/write SPI payload in bytes

// RADIOLIB_LR11X0_CMD_GET_VERSION
#define RADIOLIB_LR20xx_DEVICE_LR2021			          (0x00UL << 0)   //  7     0     HW device: LR20xx
...
#define RADIOLIB_LR20xx_CALIBRATE_ALL                           (0xFUL << 0)   //  5     0                everything
...
#define RADIOLIB_LR20xx_REG_MODE_SIMO_OFF                            (0x00UL <<0)   //      
#define RADIOLIB_LR20xx_REG_MODE_SIMO_ALL                          (0x01UL << 0)   //  

#define RADIOLIB_LR20xx_REG_MODE_SIMO_TX_ONLY                            (0x02UL <<0)   //      
#define RADIOLIB_LR20xx_REG_MODE_SIMO_VDCDC_ONLY                          (0x03UL << 0)   //  
...
//#define RADIOLIB_LR20xx_IRQ_ALL                                 (0x0BF80FFCUL)  //  31    0                all interrupts
//#define RADIOLIB_LR20xx_IRQ_NONE                                (0x00UL << 0)   //  31    0                no interrupts
*/



// RADIOLIB_LR20xx_CMD_SET_DIO_IRQ_PARAMS
#define RADIOLIB_LR20xx_IRQ_ALL                                 (0xFFFF07FFUL)  //  31    0                all interrupts
#define RADIOLIB_LR20xx_IRQ_NONE                     	  ( 0 << 0 )  //!< No interrupt
#define RADIOLIB_LR20xx_IRQ_FIFO_RX                       	  ( 1 << 0 )  //!< RX FIFO threshold reached
#define RADIOLIB_LR20xx_IRQ_FIFO_TX                       	  ( 1 << 1 )  //!< TX FIFO threshold reached
#define RADIOLIB_LR20xx_IRQ_RTTOF_RESPONDER_REQUEST_VALID 	  ( 1 << 2 )  //!< Responder received a valid RTToF request
#define RADIOLIB_LR20xx_IRQ_TX_TIMESTAMP                        ( 1 << 3 )  //!< Last bit sent timestamp
#define RADIOLIB_LR20xx_IRQ_RX_TIMESTAMP                        ( 1 << 4 )  //!< Last bit received timestamp
#define RADIOLIB_LR20xx_IRQ_PREAMBLE_DETECTED                   ( 1 << 5 )  //!< Preamble detected
#define RADIOLIB_LR20xx_IRQ_SYNC_WORD_HEADER_VALID              ( 1 << 6 )  //!< Valid LoRa header received / Sync word received
#define RADIOLIB_LR20xx_IRQ_CAD_DETECTED                        ( 1 << 7 )  //!< Activity detected during CAD operation
#define RADIOLIB_LR20xx_IRQ_LORA_RX_HEADER_TIMESTAMP            ( 1 << 8 )  //!< Last bit of LoRa header received in explicit mode,
                                                              //!< asserted after 8 symbols of payload in implicit mode
#define RADIOLIB_LR20xx_IRQ_LORA_HEADER_ERROR                   ( 1 << 9 )         //!< Erroneous LoRa header received
#define RADIOLIB_LR20xx_IRQ_POWER_SUPPLY_LOW                    ( 1 << 10 )        //!< Power supply level dropped below the threshold
#define RADIOLIB_LR20xx_IRQ_ERROR                               ( 1 << 16 )  //!< Error other than a command error occurred - call lr20xx_system_get_errors
#define RADIOLIB_LR20xx_IRQ_CMD_ERROR                           ( 1 << 17 )  //!< Host command fail/error occurred
#define RADIOLIB_LR20xx_IRQ_RX_DONE                             ( 1 << 18 )  //!< Packet received
#define RADIOLIB_LR20xx_IRQ_TX_DONE                             ( 1 << 19 )  //!< Packet sent
#define RADIOLIB_LR20xx_IRQ_CAD_DONE                            ( 1 << 20 ) //!< CAD operation done
#define RADIOLIB_LR20xx_IRQ_TIMEOUT                             ( 1 << 21 )  //!< Timeout occurred during Rx or Tx operation
#define RADIOLIB_LR20xx_IRQ_CRC_ERROR                           ( 1 << 22 )  //!< Packet received with wrong CRC
#define RADIOLIB_LR20xx_IRQ_LEN_ERROR                           ( 1 << 23 )  //!< Length of the received packet higher than expected
#define RADIOLIB_LR20xx_IRQ_ADDR_ERROR                          ( 1 << 24 )  //!< Received packet discarded - no address match
#define RADIOLIB_LR20xx_IRQ_LR_FHSS_INTRA_PKT_HOP               ( 1 << 25 )  //!< LR-FHSS intra-packet hopping occurred
#define RADIOLIB_LR20xx_IRQ_LR_FHSS_RDY_FOR_NEW_FREQ_TABLE      ( 1 << 26 )  //!< A new LR-FHSS frequency table can be loaded
#define RADIOLIB_LR20xx_IRQ_LR_FHSS_RDY_FOR_NEW_PAYLOAD         ( 1 << 27 )  //!< A new LR-FHSS payload can be loaded
#define RADIOLIB_LR20xx_IRQ_RTTOF_RESPONDER_RESPONSE_DONE       ( 1 << 28 )  //!< Responder sent an RTToF response
#define RADIOLIB_LR20xx_IRQ_RTTOF_RESPONDER_REQUEST_DISCARDED   ( 1 << 29 )  //!< Responder discarded the RTToF request - no address match
#define RADIOLIB_LR20xx_IRQ_RTTOF_INITIATOR_EXCHANGE_VALID      ( 1 << 30 )  //!< Initiator received a valid RTToF response from a responder
#define RADIOLIB_LR20xx_IRQ_RTTOF_INITIATOR_TIMEOUT             ( 1 << 31 )  //!< Initiator did not receive an RTToF response from a responder
...
// RADIOLIB_LR20xx_CMD_SET_TCXO_MODE
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_1_6                        (0x00UL << 0)   //  2     0     TCXO supply voltage: 1.6V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_1_7                        (0x01UL << 0)   //  2     0                          1.7V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_1_8                        (0x02UL << 0)   //  2     0                          1.8V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_2_2                        (0x03UL << 0)   //  2     0                          2.2V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_2_4                        (0x04UL << 0)   //  2     0                          2.4V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_2_7                        (0x05UL << 0)   //  2     0                          2.7V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_3_0                        (0x06UL << 0)   //  2     0                          3.0V
#define RADIOLIB_LR20xx_TCXO_VOLTAGE_3_3                        (0x07UL << 0)   //  2     0                          3.3V
...
// RADIOLIB_LR11X0_CMD_SET_STANDBY
#define RADIOLIB_LR20xx_STANDBY_RC                              (0x00UL << 0)   //  7     0     standby mode: RC oscillator
#define RADIOLIB_LR20xx_STANDBY_XOSC                            (0x01UL << 0)   //  7     0                   XTAL/TCXO oscillator
...
// RADIOLIB_LR20xx_CMD_SET_RX
#define RADIOLIB_LR20xx_RX_TIMEOUT_NONE                         (0x000000UL)    //  23    0     Rx timeout duration: no timeout (Rx single mode)
#define RADIOLIB_LR20xx_RX_TIMEOUT_INF                          (0xFFFFFFUL)    //  23    0                          infinite (Rx continuous mode)

// RADIOLIB_LR20xx_CMD_SET_TX
#define RADIOLIB_LR20xx_TX_TIMEOUT_NONE                         (0x000000UL)    //  23    0     disable Tx timeout
...
// RADIOLIB_LR20xx_CMD_SET_CAD_PARAMS
...
// RADIOLIB_LR20xx_CMD_SET_PACKET_TYPE  
#define RADIOLIB_LR20xx_PACKET_TYPE_LORA                        (0x00UL << 0)   //  2     0     packet type: Lora(default)
#define RADIOLIB_LR20xx_PACKET_TYPE_FSK                         (0x02UL << 0)   //  2     0                  (G)FSK
#define RADIOLIB_LR20xx_PACKET_TYPE_BLUETOOTH_LE                (0x03UL << 0)   //  2     0                  LoRa
#define RADIOLIB_LR20xx_PACKET_TYPE_NONE                       (0x04UL << 0)   //  2     0                 packet type: none  RFU 
#define RADIOLIB_LR20xx_PACKET_TYPE_FLRC                        (0x05UL << 0)   //  2     0                  GMSK/LR-FHSS
#define RADIOLIB_LR20xx_PACKET_TYPE_BPSK                        (0x06UL << 0)   //  2     0                  ranging
#define RADIOLIB_LR20xx_PACKET_TYPE_LRFHSS                      (0x07UL << 0)   //  2     0                  BLE beacon
#define RADIOLIB_LR20xx_PACKET_TYPE_WM_BUS                      (0x08UL << 0)   //  2     0 
#define RADIOLIB_LR20xx_PACKET_TYPE_WI_SUN                      (0x09UL << 0)   //  2     0 
#define RADIOLIB_LR20xx_PACKET_TYPE_OOK                         (0x0AUL << 0)   //  2     0 
#define RADIOLIB_LR20xx_PACKET_TYPE_RAW                         (0x0BUL << 0)   //  2     0 
#define RADIOLIB_LR20xx_PACKET_TYPE_Z_WAVE                      (0x0CUL << 0)   //  2     0 
#define RADIOLIB_LR20xx_PACKET_TYPE_OQPSK_15_4                  (0x0DUL << 0)   //  2     0 
...
#define RADIOLIB_LR20xx_LORA_BW_62_5                            (0x03UL << 0)   //  7     0     LoRa bandwidth: 62.5 kHz
#define RADIOLIB_LR20xx_LORA_BW_125_0                           (0x04UL << 0)   //  7     0                     125.0 kHz
#define RADIOLIB_LR20xx_LORA_BW_250_0                           (0x05UL << 0)   //  7     0                     250.0 kHz
#define RADIOLIB_LR20xx_LORA_BW_500_0                           (0x06UL << 0)   //  7     0                     500.0 kHz
#define RADIOLIB_LR20xx_LORA_BW_1000_0                          (0x07UL << 0)   //  7     0                     1000.0 kHz

#define RADIOLIB_LR20xx_FLRC_BR_2_600_BW_2_6                    0x00        //  7     0   FLRC bit rate and
#define RADIOLIB_LR20xx_FLRC_BR_2_080_BW_2_6                    0x01        //  7     0   FLRC bit rate and
#define RADIOLIB_LR20xx_FLRC_BR_1_300_BW_1_2                    0x02        //  7     0   FLRC bit rate and bandwidth setting: 1.3 Mbps   1.2 MHz
#define RADIOLIB_LR20xx_FLRC_BR_1_040_BW_1_2                    0x03        //  7     0                                        1.04 Mbps  1.2 MHz
#define RADIOLIB_LR20xx_FLRC_BR_0_650_BW_0_6                    0x04        //  7     0                                        0.65 Mbps  0.6 MHz
#define RADIOLIB_LR20xx_FLRC_BR_0_520_BW_0_6                    0x05        //  7     0                                        0.52 Mbps  0.6 MHz
#define RADIOLIB_LR20xx_FLRC_BR_0_325_BW_0_3                    0x06        //  7     0                                        0.325 Mbps 0.3 MHz
#define RADIOLIB_LR20xx_FLRC_BR_0_260_BW_0_3                    0x07        //  7     0                                        0.260 Mbps 0.3 MHz





#define RADIOLIB_LR20xx_FLRC_CR_1_2                             0x00        //  7     0   FLRC coding rate: 1/2
#define RADIOLIB_LR20xx_FLRC_CR_3_4                             0x01        //  7     0                     3/4
#define RADIOLIB_LR20xx_FLRC_CR_1_1                             0x02       //  7     0                     1/1
#define RADIOLIB_LR20xx_FLRC_CR_2_3                             0x03        //  7     0                     2/3





#define RADIOLIB_LR20xx_FLRC_BT_OFF                             0x00        //  7     0   FLRC Gaussian filter BT product: filter disabled
#define RADIOLIB_LR20xx_FLRC_BT_1_0                             0x10        //  7     0                                    1.0
#define RADIOLIB_LR20xx_FLRC_BT_0_5                             0x20        //  7     0                                    0.5

#define    RADIOLIB_LR20xx_FLRC_PULSE_SHAPE_OFF     0x00
#define    RADIOLIB_LR20xx_FLRC_PULSE_SHAPE_BT_05   0x05
#define    RADIOLIB_LR20xx_FLRC_PULSE_SHAPE_BT_1    0x07


#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_04_BITS   0x00
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_08_BITS   0x01
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_12_BITS   0x02
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_16_BITS   0x03
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_20_BITS   0x04
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_24_BITS   0x05
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_28_BITS   0x06
#define    RADIOLIB_LR20xx_FLRC_PREAMBLE_LEN_32_BITS   0x07



 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_OFF           0x00  //!< No syncword match
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_1             0x01  //!< Match syncword #1
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_2             0x02  //!< Match syncword #2
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_1_OR_2        0x03  //!< Match syncword #1 or #2
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_3             0x04  //!< Match syncword #3
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_1_OR_3        0x05  //!< Match syncword #1 or #3
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_2_OR_3        0x06  //!< Match syncword #2 or #3
 #define   RADIOLIB_LR20xx_FLRC_RX_MATCH_SYNCWORD_1_OR_2_OR_3   0x07  //!< Match syncword #1 or #2 or #3



 #define   RADIOLIB_LR20xx_FLRC_SYNCWORD_LENGTH_OFF       0x00
 #define   RADIOLIB_LR20xx_FLRC_SYNCWORD_LENGTH_2_BYTES   0x01
 #define   RADIOLIB_LR20xx_FLRC_SYNCWORD_LENGTH_4_BYTES   0x02



#define   RADIOLIB_LR20xx_FLRC_PKT_VAR_LEN    0x00
#define    RADIOLIB_LR20xx_FLRC_PKT_FIX_LEN   0x01




#define   RADIOLIB_LR20xx_FLRC_CRC_OFF        0x00
#define   RADIOLIB_LR20xx_FLRC_CRC_2_BYTES   0x01
#define   RADIOLIB_LR20xx_FLRC_CRC_3_BYTES    0x02
#define   RADIOLIB_LR20xx_FLRC_CRC_4_BYTES    0x03

#define RADIOLIB_LR20xx_LORA_CR_NONE                            (0x00UL << 0)   //  7     0                  //!< No Coding Rate
#define RADIOLIB_LR20xx_LORA_CR_4_5_SHORT                       (0x01UL << 0)   //  7     0     coding rate: //!< Short Interleaver Parity code
#define RADIOLIB_LR20xx_LORA_CR_4_6_SHORT                       (0x02UL << 0)   //  7     0                  //!< Short Interleaver Hamming code 2/3
#define RADIOLIB_LR20xx_LORA_CR_4_7_SHORT                       (0x03UL << 0)   //  7     0                  //!< Short Interleaver Hamming code 7/5
#define RADIOLIB_LR20xx_LORA_CR_4_8_SHORT                       (0x04UL << 0)   //  7     0                  //!< Short Interleaver Hamming code 1/2
#define RADIOLIB_LR20xx_LORA_CR_4_5_LONG                        (0x05UL << 0)   //  7     0                  //!< Long Interleaver Parity code
#define RADIOLIB_LR20xx_LORA_CR_4_6_LONG                        (0x06UL << 0)   //  7     0                  //!< Long Interleaver Hamming code 2/3
#define RADIOLIB_LR20xx_LORA_CR_4_8_LONG                        (0x07UL << 0)   //  7     0                  //!< Long Interleaver Hamming code 1/2
#define RADIOLIB_LR20xx_LORA_CR_4_6_LONG_CONV                   (0x08UL << 0)   //  7     0                  //!< Long Interleaver Convolutional code 2/3
#define RADIOLIB_LR20xx_LORA_CR_4_8_LONG_CONV                   (0x09UL << 0)   //  7     0                  //!< Long Interleaver Convolutional code 1/2

#define RADIOLIB_LR20xx_LORA_LDRO_DISABLED                      (0x00UL << 0)   //  7     0     low data rate optimize: disabled
#define RADIOLIB_LR20xx_LORA_LDRO_ENABLED                       (0x01UL << 0)   //  7     0                             enabled




#define RADIOLIB_LR20xx_GFSK_SHAPING_NONE                       (0x00UL << 0)   //  7     0     shaping filter: none
#define RADIOLIB_LR20xx_GFSK_SHAPING_GAUSSIAN_BT_0_2            (0x02UL << 0)   //  7     0                  //!< Pulse shaping Gaussian with BT 2.0
#define RADIOLIB_LR20xx_GFSK_SHAPING_ROOT_RAISED_COSINE_ROLL_OFF_0_4            (0x03UL << 0)   //  7     0  //!< Pulse shaping Root-Raised-Cosine with Roll-Off 0.4
#define RADIOLIB_LR20xx_GFSK_SHAPING_GAUSSIAN_BT_0_3            (0x04UL << 0)   //  7     0                     Gaussian, BT = 0.3
#define RADIOLIB_LR20xx_GFSK_SHAPING_GAUSSIAN_BT_0_5            (0x05UL << 0)   //  7     0                     Gaussian, BT = 0.5
#define RADIOLIB_LR20xx_GFSK_SHAPING_GAUSSIAN_BT_0_7            (0x06UL << 0)   //  7     0                     Gaussian, BT = 0.7
#define RADIOLIB_LR20xx_GFSK_SHAPING_GAUSSIAN_BT_1_0            (0x07UL << 0)   //  7     0                     Gaussian, BT = 1.0


#define RADIOLIB_LR20xx_GFSK_SHAPING_RAISED_COSINE_ROLL_OFF_0_3       (0x08UL << 0)   //  7     0 //!< Pulse shaping Raised-Cosine with Roll-Off 0.3
#define RADIOLIB_LR20xx_GFSK_SHAPING_RAISED_COSINE_ROLL_OFF_0_5       (0x09UL << 0)   //  7     0 //!< Pulse shaping Raised-Cosine with Roll-Off 0.5               
#define RADIOLIB_LR20xx_GFSK_SHAPING_RAISED_COSINE_ROLL_OFF_0_7       (0x0AUL << 0)   //  7     0 //!< Pulse shaping Raised-Cosine with Roll-Off 0.7
#define RADIOLIB_LR20xx_GFSK_SHAPING_RAISED_COSINE_ROLL_OFF_1_0       (0x0BUL << 0)   //  7     0 //!< Pulse shaping Raised-Cosine with Roll-Off 1.0


#define RADIOLIB_LR20xx_GFSK_SHAPING_ROOT_RAISED_COSINE_ROLL_OFF_0_3       (0x0CUL << 0)   //  7     0 //!< Pulse shaping Root-Raised-Cosine with Roll-Off 0.3
#define RADIOLIB_LR20xx_GFSK_SHAPING_ROOT_RAISED_COSINE_ROLL_OFF_0_5       (0x0DUL << 0)   //  7     0 //!< Pulse shaping Root-Raised-Cosine with Roll-Off 0.5
#define RADIOLIB_LR20xx_GFSK_SHAPING_ROOT_RAISED_COSINE_ROLL_OFF_0_7       (0x0EUL << 0)   //  7     0 //!< Pulse shaping Root-Raised-Cosine with Roll-Off 0.7
#define RADIOLIB_LR20xx_GFSK_SHAPING_ROOT_RAISED_COSINE_ROLL_OFF_1_0       (0x0FUL << 0)   //  7     0 //!< Pulse shaping Root-Raised-Cosine with Roll-Off 1.0

#define RADIOLIB_LR20xx_GFSK_RX_BW_3_500_HZ      0xE7  //!< RX Bandwidth 3.5 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_4_200_HZ      0xA7  //!< RX Bandwidth 4.2 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_4_300_HZ      0xDF  //!< RX Bandwidth 4.3 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_4_500_HZ      0x67  //!< RX Bandwidth 4.5 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_4_800_HZ      0x27  //!< RX Bandwidth 4.8 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_5_200_HZ      0x9F  //!< RX Bandwidth 5.2 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_5_600_HZ      0x5F  //!< RX Bandwidth 5.6 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_5_800_HZ      0xD7  //!< RX Bandwidth 5.8 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_6_000_HZ      0x1F  //!< RX Bandwidth 6 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_6_900_HZ      0xE6  //!< RX Bandwidth 6.9 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_7_400_HZ      0x57  //!< RX Bandwidth 7.4 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_8_000_HZ      0x17  //!< RX Bandwidth 8 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_8_300_HZ      0xA6  //!< RX Bandwidth 8.3 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_8_700_HZ      0xDE  //!< RX Bandwidth 8.7 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_8_900_HZ      0x66  //!< RX Bandwidth 8.9 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_9_600_HZ      0x26  //!< RX Bandwidth 9.6 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_10_000_HZ     0x9E  //!< RX Bandwidth 10 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_11_000_HZ     0x5E  //!< RX Bandwidth 11 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_12_000_HZ     0x1E  //!< RX Bandwidth 12 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_13_000_HZ     0xE5  //!< RX Bandwidth 13 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_14_000_HZ     0x56  //!< RX Bandwidth 14 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_16_000_HZ     0xA5  //!< RX Bandwidth 16 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_17_000_HZ     0x65  //!< RX Bandwidth 17 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_19_000_HZ     0x25  //!< RX Bandwidth 19 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_20_000_HZ     0x9D  //!< RX Bandwidth 20 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_22_000_HZ     0x5D  //!< RX Bandwidth 22 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_23_000_HZ     0xD5  //!< RX Bandwidth 23 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_24_000_HZ     0x1D  //!< RX Bandwidth 24 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_27_000_HZ     0xE4  //!< RX Bandwidth 27 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_29_000_HZ     0x55  //!< RX Bandwidth 29 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_32_000_HZ     0x15  //!< RX Bandwidth 32 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_33_000_HZ     0xA4  //!< RX Bandwidth 33 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_34_000_HZ     0xDC  //!< RX Bandwidth 34 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_35_000_HZ     0x64  //!< RX Bandwidth 35 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_38_000_HZ     0x24  //!< RX Bandwidth 38 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_41_000_HZ     0x9C  //!< RX Bandwidth 41 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_44_000_HZ     0x5C  //!< RX Bandwidth 44 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_46_000_HZ     0xD4  //!< RX Bandwidth 46 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_48_000_HZ     0x1C  //!< RX Bandwidth 48 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_55_000_HZ     0xE3  //!< RX Bandwidth 55 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_59_000_HZ     0x54  //!< RX Bandwidth 59 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_64_000_HZ     0x14  //!< RX Bandwidth 64 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_66_000_HZ     0xA3  //!< RX Bandwidth 66 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_69_000_HZ     0xDB  //!< RX Bandwidth 69 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_71_000_HZ     0x63  //!< RX Bandwidth 71 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_76_000_HZ     0x23  //!< RX Bandwidth 76 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_83_000_HZ     0x9B  //!< RX Bandwidth 83 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_89_000_HZ     0x5B  //!< RX Bandwidth 89 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_92_000_HZ     0xD3  //!< RX Bandwidth 92 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_96_000_HZ     0x1B  //!< RX Bandwidth 96 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_111_000_HZ    0xE2  //!< RX Bandwidth 111 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_119_000_HZ    0x53  //!< RX Bandwidth 119 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_128_000_HZ    0x13  //!< RX Bandwidth 128 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_133_000_HZ    0xA2  //!< RX Bandwidth 133 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_138_000_HZ    0xDA  //!< RX Bandwidth 138 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_142_000_HZ    0x62  //!< RX Bandwidth 142 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_153_000_HZ    0x22  //!< RX Bandwidth 153 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_166_000_HZ    0x9A  //!< RX Bandwidth 166 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_178_000_HZ    0x5A  //!< RX Bandwidth 178 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_185_000_HZ    0xD2  //!< RX Bandwidth 185 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_192_000_HZ    0x1A  //!< RX Bandwidth 192 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_222_000_HZ    0xE1  //!< RX Bandwidth 222 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_238_000_HZ    0x52  //!< RX Bandwidth 238 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_256_000_HZ    0x12  //!< RX Bandwidth 256 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_266_000_HZ    0xA1  //!< RX Bandwidth 266 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_277_000_HZ    0xD9  //!< RX Bandwidth 277 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_285_000_HZ    0x61  //!< RX Bandwidth 285 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_307_000_HZ    0x21  //!< RX Bandwidth 307 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_333_000_HZ    0x99  //!< RX Bandwidth 333 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_357_000_HZ    0x59  //!< RX Bandwidth 357 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_370_000_HZ    0xD1  //!< RX Bandwidth 370 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_384_000_HZ    0x19  //!< RX Bandwidth 384 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_444_000_HZ    0xE0  //!< RX Bandwidth 444 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_476_000_HZ    0x51  //!< RX Bandwidth 476 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_512_000_HZ    0x11  //!< RX Bandwidth 512 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_533_000_HZ    0xA0  //!< RX Bandwidth 533 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_555_000_HZ    0xD8  //!< RX Bandwidth 555 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_571_000_HZ    0x60  //!< RX Bandwidth 571 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_615_000_HZ    0x20  //!< RX Bandwidth 615 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_666_000_HZ    0x98  //!< RX Bandwidth 666 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_714_000_HZ    0x58  //!< RX Bandwidth 714 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_740_000_HZ    0xD0  //!< RX Bandwidth 740 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_769_000_HZ    0x18  //!< RX Bandwidth 769 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_888_000_HZ    0x90  //!< RX Bandwidth 888 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_1_111_000_HZ  0xC8  //!< RX Bandwidth 1111 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_1_333_000_HZ  0x88  //!< RX Bandwidth 1333 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_2_222_000_HZ  0xC0  //!< RX Bandwidth 2222 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_2_666_000_HZ  0x80  //!< RX Bandwidth 2666 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_2_857_000_HZ  0x40  //!< RX Bandwidth 2857 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_3_076_000_HZ  0x00  //!< RX Bandwidth 3076 kHz
#define RADIOLIB_LR20xx_GFSK_RX_BW_AUTO          0xFF  //!< RX Bandwidth automatic choice - limited to Wi-SUN, Wireless M-BUS and Z-Wave


#define   RADIOLIB_LR20xx_GFSK_PREAMBLE_DETECTOR_DISABLED      0x00  //!< Preamble detector disabled - detection on syncword
#define   RADIOLIB_LR20xx_GFSK_PREAMBLE_DETECTOR_8_BITS        0x08  //!< Preamble detector set to 8 bits
#define   RADIOLIB_LR20xx_GFSK_PREAMBLE_DETECTOR_16_BITS       0x10  //!< Preamble detector set to 16 bits
#define   RADIOLIB_LR20xx_GFSK_PREAMBLE_DETECTOR_24_BITS       0x18  //!< Preamble detector set to 24 bits
#define   RADIOLIB_LR20xx_GFSK_PREAMBLE_DETECTOR_32_BITS       0x20  //!< Preamble detector set to 32 bits



#define    RADIOLIB_LR20xx_GFSK_CRC_OFF               0x00  //!< CRC is not added to packet
#define    RADIOLIB_LR20xx_GFSK_CRC_1_BYTE            0x01  //!< CRC is 1-byte long
#define    RADIOLIB_LR20xx_GFSK_CRC_2_BYTES           0x02  //!< CRC is 2-byte long
#define    RADIOLIB_LR20xx_GFSK_CRC_3_BYTES           0x03  //!< CRC is 3-byte long
#define    RADIOLIB_LR20xx_GFSK_CRC_4_BYTES           0x04  //!< CRC is 4-byte long
#define    RADIOLIB_LR20xx_GFSK_CRC_1_BYTE_INVERTED   0x09  //!< CRC is 1-byte long and inverted
#define    RADIOLIB_LR20xx_GFSK_CRC_2_BYTES_INVERTED  0x0A  //!< CRC is 2-byte long and inverted
#define    RADIOLIB_LR20xx_GFSK_CRC_3_BYTES_INVERTED  0x0B  //!< CRC is 3-byte long and inverted
#define    RADIOLIB_LR20xx_GFSK_CRC_4_BYTES_INVERTED  0x0C  //!< CRC is 4-byte long and inverted




#define    RADIOLIB_LR20xx_GFSK_HEADER_IMPLICIT         0x00  //!< (aka. fixed length packet) The packet is sent without header so the receiver must be configured to
               //!< receive the same payload length as the transmitted one
#define    RADIOLIB_LR20xx_GFSK_HEADER_8BITS         0x01  //!< The packet can have variable payload length encoded in a 8 bits
                                           //!< header. Compatible with SX126X and SX127X
#define    RADIOLIB_LR20xx_GFSK_HEADER_SX128X_COMPATIBLE 0x02  //!< The packet can have a variable payload length up to 255 bytes. The packet header is compatible with
               //!< SX128X: payload length is encoded on 9 bits but MSB is RFU
#define    RADIOLIB_LR20xx_GFSK_HEADER_16BITS       0x03  //!< Variable payload length encoded on 15LSBs - MSB is RFU

#define    RADIOLIB_LR20xx_GFSK_ADDRESS_FILTERING_DISABLED         0x00  //!< Disable address filtering
#define    RADIOLIB_LR20xx_GFSK_ADDRESS_FILTERING_NODE             0x01  //!< Filter on node address
#define    RADIOLIB_LR20xx_GFSK_ADDRESS_FILTERING_NODE_BROADCAST   0x02  //!< Filter on both node and broadcast addresses



#define    RADIOLIB_LR20xx_GFSK_WHITENING_OFF               0x00  //!< Whitening is disabled
#define    RADIOLIB_LR20xx_GFSK_WHITENING_ON                0x01  //!< Whitening is enabled
...
#define RADIOLIB_LR20xx_LORA_PAYLOAD_LEN_ANY                    (0x00UL << 0)   //  7     0     accept any payload length
#define RADIOLIB_LR20xx_LORA_CRC_ENABLED                        (0x01UL << 0)   //  7     0     CRC: enabled
#define RADIOLIB_LR20xx_LORA_CRC_DISABLED                       (0x00UL << 0)   //  7     0          disabled
#define RADIOLIB_LR20xx_LORA_IQ_STANDARD                        (0x00UL << 0)   //  7     0     IQ setup: standard
#define RADIOLIB_LR20xx_LORA_IQ_INVERTED                        (0x01UL << 0)   //  7     0               inverted
#define RADIOLIB_LR20xx_LORA_HEADER_EXPLICIT                    (0x00UL << 0)   //  7     0     LoRa header mode: explicit
#define RADIOLIB_LR20xx_LORA_HEADER_IMPLICIT                    (0x01UL << 0)   //  7     0                       implicit
#define RADIOLIB_LR20xx_LORA_CRC_ENABLED                        (0x01UL << 0)   //  7     0     CRC: enabled
#define RADIOLIB_LR20xx_LORA_CRC_DISABLED                       (0x00UL << 0)   //  7     0          disabled
...
// RADIOLIB_LR20xx_CMD_SET_TX_PARAMS
#define  RADIOLIB_LR20xx_PA_RAMP_2_US   	 (0x00)  //!< 2 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_4_US   	 (0x01)  //!< 4 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_8_US   	 (0x02)  //!< 8 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_16_US  	 (0x03)  //!< 16 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_32_US  	 (0x04)  //!< 32 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_48_US  	 (0x05)  //!< 48 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_64_US  	 (0x06)  //!< 64 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_80_US  	 (0x07)  //!< 80 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_96_US  	 (0x08)  //!< 96 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_112_US 	 (0x09)  //!< 112 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_128_US 	 (0x0A)  //!< 128 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_144_US 	 (0x0B)  //!< 144 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_160_US 	 (0x0C)  //!< 160 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_176_US 	 (0x0D)  //!< 176 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_192_US 	 (0x0E)  //!< 192 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_208_US 	 (0x0F)  //!< 208 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_240_US 	 (0x10)  //!< 240 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_272_US 	 (0x11)  //!< 272 us Ramp Time
#define  RADIOLIB_LR20xx_PA_RAMP_304_US 	 (0x12)  //!< 304 us Ramp Time
...
// RADIOLIB_LR11X0_CMD_SET_RX_TX_FALLBACK_MODE
#define RADIOLIB_LR20xx_FALLBACK_MODE_STBY_RC                   (0x01UL << 0)   //  1     0     fallback mode after Rx/Tx: standby with RC
#define RADIOLIB_LR20xx_FALLBACK_MODE_STBY_XOSC                 (0x02UL << 0)   //  1     0                                standby with XOSC
#define RADIOLIB_LR20xx_FALLBACK_MODE_FS                        (0x03UL << 0)   //  1     0                                frequency synthesis
...
// RADIOLIB_LR20xx_CMD_SET_LORA_SYNC_WORD
#define RADIOLIB_LR20xx_LORA_SYNC_WORD_PRIVATE                  (0x12)
#define RADIOLIB_LR20xx_LORA_SYNC_WORD_PUBLIC                   (0x34)
...
*/
class LR20xx: public PhysicalLayer {
  public:
...
/*!
    ...
    */
    ...
    /*!
      ...
      \returns \ref status_codes
    */
    int16_t startReceive(uint32_t timeout, uint32_t irqFlags = RADIOLIB_LR20xx_IRQ_RX_DONE, uint32_t irqMask = 0, size_t len = 0);
    ...
    */
    ...
    uint32_t get_clear_IrqStatus();

    uint16_t getFifoIrqFlags();
    int16_t  clearFifoIrqFlags(uint8_t rx_fifo_flags,uint8_t tx_fifo_flags);
    uint16_t get_clear_FifoIrqFlags(); 
    /*!
    ...
    */
    ...
    size_t getRxFifoLevel();
    
    size_t getTxFifoLevel();
    /*!
    ...
    */
    ...
    int16_t patch_load_pram(const uint32_t address, const uint32_t* buffer,const uint32_t length);
    
    int16_t patch_execute_spare(uint8_t command_index,const uint8_t* command_arguments, uint16_t command_n_arguments,
                                            uint8_t* command_outputs, uint16_t command_n_outputs);
    int16_t patch_execute_spare_write(uint8_t command_index,const uint8_t* command_arguments, uint16_t command_n_arguments);
    int16_t patch_execute_spare_read(uint8_t command_index,const uint8_t* command_arguments, uint16_t command_n_arguments,
                                                 uint8_t* command_outputs, uint16_t command_n_outputs );                                       
    ...
    int16_t getRxStatsFLRC(uint16_t* pkt_rx, uint16_t* pkt_crc_err,uint16_t* pkt_len_err);
    int16_t getPacketStatusFLRC(float* rssiSync, float* rssiAvg,uint16_t* rxLen,uint8_t* sw_num);
  ...
  protected:
    ...
    int16_t calibrate_front_end(uint8_t rx_path_hf_lf_1,uint32_t freq1,uint8_t rx_path_hf_lf_2,uint32_t freq2,uint8_t rx_path_hf_lf_3,uint32_t freq3);
    int16_t setRegMode(uint8_t mode);
    //int16_t calibImage(float freq1, float freq2);
    int16_t setDioFunction(uint8_t dio, uint8_t func,uint8_t pull_drive);
    ...
    int16_t setDioRfSwitchCfg(uint8_t dio,uint8_t tx_hf, uint8_t rx_hf, uint8_t tx_lf, uint8_t rx_lf,uint8_t stbyCfg);
    int16_t setDioIrqParams(uint8_t dio, uint32_t irq);
    int16_t configFifoIrq(uint8_t RxFifoEnable,uint8_t TxFifoEnable, uint16_t RxHighThreshold,uint16_t TxLowThreshold,uint16_t RxLowThreshold,uint16_t TxHighThreshold); 
    ...
    int16_t setModulationParamsFLRC(uint8_t BitRateBw, uint8_t cr, uint8_t pluseShape);
    int16_t setPacketParamsLoRa(uint16_t preambleLen, uint8_t hdrType, uint8_t payloadLen, uint8_t crcType, uint8_t invertIQ);
    int16_t setPacketParamsGFSK(uint16_t preambleLen, uint8_t preambleDetectorLen, uint8_t payloadLen_unit, uint8_t addrCmp, uint8_t packType, uint16_t payloadLen, uint8_t crcType, uint8_t whiten);
    int16_t setPacketParamsSigfox(uint8_t payloadLen, uint16_t rampUpDelay, uint16_t rampDownDelay, uint16_t bitNum);
    int16_t setPacketParamsFLRC(uint8_t preambleLen,uint8_t sync_word_len,uint8_t match_sync_word,uint8_t hdrType, uint16_t payloadLen, uint8_t crcType);
    int16_t setTxParams(int8_t pwr, uint8_t ramp);
    int16_t setRxPath(uint8_t rx_path, uint8_t boost_level);
    ...
    int16_t setPaConfig(uint8_t paSel, uint8_t paLfMode, uint8_t paLfDutyCycle, uint8_t paLfSlices,uint8_t paHfDutyCycle);
    int16_t setPa(uint8_t pa_sel);
    int16_t stopTimeoutOnPreamble(bool stop);
    int16_t setCad(void);
    int16_t setTxCw(uint8_t mode=0);
    ...
    int16_t setLoRaSyncWord(uint16_t sync);
    int16_t setFSKSyncWord(uint64_t sync,uint8_t bit_order,uint8_t nb_bits);
    int16_t setFLRCSyncWord(uint8_t sync_num,uint32_t sync);
  ...
  private:
	...
	//FLRC params
   uint8_t preambleLengthFLRC = 0;
   uint8_t crcTypeFLRC = 0;
   uint8_t codingRateFLRC = 0;
   uint8_t shaping=0;
   uint16_t bitRateKbps = 0;
  
   uint8_t  syncWordLen=0;
   uint8_t syncWordMatch=0;
   uint8_t crcFLRC=0;
